-- ============================================================================
-- DESTINATION PAGES - SEED DATA (Compatible with current schema)
-- ============================================================================
-- Adds missing destinations and transfer packages
-- Compatible with existing seasons table (no priority column needed)
-- ============================================================================
...
-- Update existing destinations with SEO meta tags
UPDATE destinations SET
  meta_title = COALESCE(meta_title, 'Nainital to ' || name || ' Taxi Service - Book Affordable Cabs'),
  meta_description = COALESCE(meta_description, 'Book taxi from Nainital to ' || name || '. Reliable service, fixed rates, comfortable vehicles.')
...
BEGIN
  ...
  -- Get season IDs - Simple query without priority
  ...
  -- If seasons don't exist, create them
  IF off_season_id IS NULL THEN
    INSERT INTO seasons (name, description, start_date, end_date, is_active)
    VALUES ('Off-Season', 'Year-round regular pricing', '2025-01-01', '2025-12-31', TRUE)
    RETURNING id INTO off_season_id;
  END IF;

  IF peak_season_id IS NULL THEN
    INSERT INTO seasons (name, description, start_date, end_date, is_active)
    VALUES ('Season', 'Summer peak season', '2025-04-15', '2025-06-30', TRUE)
    RETURNING id INTO peak_season_id;
  END IF;
  ...
  INSERT INTO pricing (package_id, vehicle_type, season_id, price, notes) VALUES
    (ranikhet_pkg_id, 'sedan', off_season_id, 2800, 'Sedan off-season'),
    (ranikhet_pkg_id, 'suv_normal', off_season_id, 3200, 'SUV Basic off-season'),
    (ranikhet_pkg_id, 'suv_deluxe', off_season_id, 3800, 'SUV Deluxe off-season'),
    (ranikhet_pkg_id, 'suv_luxury', off_season_id, 4200, 'SUV Luxury off-season'),

    (ranikhet_pkg_id, 'sedan', peak_season_id, 3200, 'Sedan peak'),
    (ranikhet_pkg_id, 'suv_normal', peak_season_id, 3800, 'SUV Basic peak'),
    (ranikhet_pkg_id, 'suv_deluxe', peak_season_id, 4200, 'SUV Deluxe peak'),
    (ranikhet_pkg_id, 'suv_luxury', peak_season_id, 4800, 'SUV Luxury peak')
  ON CONFLICT (package_id, vehicle_type, season_id) DO UPDATE SET
  ...
  -- ======================================
  INSERT INTO pricing (package_id, vehicle_type, season_id, price, notes) VALUES
    (mukteshwar_pkg_id, 'sedan', off_season_id, 2500, 'Sedan off-season'),
    (mukteshwar_pkg_id, 'suv_normal', off_season_id, 3000, 'SUV Basic off-season'),
    (mukteshwar_pkg_id, 'suv_deluxe', off_season_id, 3500, 'SUV Deluxe off-season'),
    (mukteshwar_pkg_id, 'suv_luxury', off_season_id, 4000, 'SUV Luxury off-season'),

    (mukteshwar_pkg_id, 'sedan', peak_season_id, 3000, 'Sedan peak'),
    (mukteshwar_pkg_id, 'suv_normal', peak_season_id, 3500, 'SUV Basic peak'),
    (mukteshwar_pkg_id, 'suv_deluxe', peak_season_id, 4000, 'SUV Deluxe peak'),
    (mukteshwar_pkg_id, 'suv_luxury', peak_season_id, 4500, 'SUV Luxury peak')
  ON CONFLICT (package_id, vehicle_type, season_id) DO UPDATE SET
    price = EXCLUDED.price,
    updated_at = CURRENT_TIMESTAMP;
  ...
  -- ======================================
  INSERT INTO pricing (package_id, vehicle_type, season_id, price, notes) VALUES
    (kainchi_pkg_id, 'sedan', off_season_id, 1200, 'Sedan off-season'),
    (kainchi_pkg_id, 'suv_normal', off_season_id, 1500, 'SUV Basic off-season'),
    (kainchi_pkg_id, 'suv_deluxe', off_season_id, 1800, 'SUV Deluxe off-season'),
    (kainchi_pkg_id, 'suv_luxury', off_season_id, 2200, 'SUV Luxury off-season'),

    (kainchi_pkg_id, 'sedan', peak_season_id, 1500, 'Sedan peak'),
    (kainchi_pkg_id, 'suv_normal', peak_season_id, 1800, 'SUV Basic peak'),
    (kainchi_pkg_id, 'suv_deluxe', peak_season_id, 2200, 'SUV Deluxe peak'),
    (kainchi_pkg_id, 'suv_luxury', peak_season_id, 2500, 'SUV Luxury peak')
  ON CONFLICT (package_id, vehicle_type, season_id) DO UPDATE SET
    price = EXCLUDED.price,
    updated_at = CURRENT_TIMESTAMP;
  ...
  -- ======================================
  INSERT INTO pricing (package_id, vehicle_type, season_id, price, notes) VALUES
    (corbett_pkg_id, 'sedan', off_season_id, 4500, 'Sedan off-season'),
    (corbett_pkg_id, 'suv_normal', off_season_id, 5500, 'SUV Basic off-season'),
    (corbett_pkg_id, 'suv_deluxe', off_season_id, 6500, 'SUV Deluxe off-season'),
    (corbett_pkg_id, 'suv_luxury', off_season_id, 7500, 'SUV Luxury off-season'),

    (corbett_pkg_id, 'sedan', peak_season_id, 5500, 'Sedan peak'),
    (corbett_pkg_id, 'suv_normal', peak_season_id, 6500, 'SUV Basic peak'),
    (corbett_pkg_id, 'suv_deluxe', peak_season_id, 7500, 'SUV Deluxe peak'),
    (corbett_pkg_id, 'suv_luxury', peak_season_id, 8500, 'SUV Luxury peak')
  ON CONFLICT (package_id, vehicle_type, season_id) DO UPDATE SET
    price = EXCLUDED.price,
    updated_at = CURRENT_TIMESTAMP;

  RAISE NOTICE 'Successfully added all destinations, packages, and pricing!';
END $$;
...
SELECT slug, name, distance_from_nainital FROM destinations WHERE slug IN ('kathgodam', 'pantnagar', 'jim-corbett', 'ranikhet', 'mukteshwar', 'kainchi-dham');

SELECT '=== TRANSFER PACKAGES ===' as info;
SELECT slug, title, distance FROM packages WHERE type = 'transfer' AND slug LIKE 'nainital-%';

SELECT '=== PRICING COUNT ===' as info;
SELECT
  p.title,
  COUNT(pr.id) as pricing_entries
FROM packages p
